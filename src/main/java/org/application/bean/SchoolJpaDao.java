...
import org.application.event.StudentCoursePayload;
import org.application.model.BaseEntity;
import org.application.model.Course;
import org.application.model.Person;
import org.application.model.Student;
import org.application.model.Teacher;
import org.application.qualifier.DataRepository;
import org.application.qualifier.StudentAdded;
import org.application.qualifier.StudentRemoved;
...
public class SchoolJpaDao implements SchoolDao {
	...
	/* (non-Javadoc)
	 * @see org.application.bean.SchoolDao#searchStudents(org.application.bean.SearchCriteria, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
